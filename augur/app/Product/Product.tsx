...
const Product: React.FC = () => {
  ...
  const products: ProductItem[] = [
    {
      ...
      subItems: [
        {
          id: 1, name: 'AUTOMATED MARKET MAKER',
          content: 'A simple way for traders to buy and sell shares, and liquidity providers can supply liquidity to earn fees.',
          availability: 'NOT SUPPORTED IN YOUR REGION',
          img: Image1,
        },
        {
          id: 2, name: 'PROVIDE LIQUIDITY',
    ...
    },
    {
      ...
      subItems: [
        {
          id: 3, name: 'SPORTSBOOK',
          content: 'Place a wager on your favourite team, game or sporting event.',
          availability: 'NOT SUPPORTED IN YOUR REGION',
          img: Image2,
        },
        {
          id: 4, name: 'BETTING EXCHANGE',
          content: 'Be the bookmaker: the betting exchange is where bets placed and layed are matched against each other. Back or lay any event.',
  ...
  const [selectedSubItem, setSelectedSubItem] = useState(selectedProduct.subItems[0]); // Default to the first subitem
              ...
              {selectedProduct.subItems && (
                <div className="flex gap-4 mt-0">
                  {selectedProduct.subItems.map((subItem, index) => (
                    <div
                      key={index}
                      className={`my-4 subitem ${selectedSubItem === subItem ? 'border-green-500' : ''}`}
